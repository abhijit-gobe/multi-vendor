  ...
  return (
    <nav className="h-20 flex border-b justify-between font-medium bg-white">
        ...
        <div className="hidden lg:flex">
            ...
            <Button
                asChild
                className="border-l border-t-0 border-b-0 border-r-0 rounded-none px-12 h-full bg-black hover:bg-pink-400 transition-colors text-lg text-white hover:text-black"
            >
                <Link href={"/sign-up"}>
                    Start selling
                </Link>
